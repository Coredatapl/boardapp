...
export default function SearchEngineSelector({
  ...
  return (
    <>
      <button
        ref={widgetButtonRef}
        className="absolute top-0 right-0 h-full p-2.5 z-20 inline-flex items-center rounded-r-lg text-sm font-medium text-center text-gray-800 bg-gray-100 hover:bg-gray-200 focus:outline-none"
        type="button"
      ...
      >
        ...
        <svg
          className={`w-3 h-3 ml-3 transition-all transform ease-in-out ${
          ...
          >
            ...
            <li>
              <button
                ...
                className="inline-flex w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-200"
                role="menuitem"
                onClick={() => selectSearchEngine(SearchEngineEnum.DuckDuckGo)}
              >
                <div className="inline-flex items-center">
                  <img
                    className="w-3 h-3 mr-2"
                    src={engineIcon[SearchEngineEnum.DuckDuckGo]}
                  />
                  DuckDuckGo
                </div>
              </button>
