		...
		>
			...
			>
				...
				<input
					...
					name="searchInput"
					type="text"
					className="search-input w-full pl-11 pr-4 py-3 rounded-2xl border-none outline-none text-md text-gray-700 dark:text-white/85 bg-white dark:bg-black/30 placeholder-gray-400 dark:placeholder-white/25 transition-all duration-200"
